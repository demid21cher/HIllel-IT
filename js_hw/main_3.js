...
class CalorieCalculator {
  constructor() {
    this.foodCalories = new Map();
  }

  addProduct(productName, calories) {
    this.foodCalories.set(productName, calories);
  }

  getProductCalories(productName) {
    if (this.foodCalories.has(productName)) {
      return this.foodCalories.get(productName);
    }
    return 'Product not found';
  }

  removeProduct(productName) {
    this.foodCalories.delete(productName);
  }
}
